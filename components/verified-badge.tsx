      ...
      <Tooltip delayDuration={300}>
        <TooltipTrigger asChild>
          <svg
            ...
            className="w-[18px] h-[18px] inline-block cursor-help"
        ...
        <TooltipContent side="top" className="max-w-xs">
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">
              This account has been verified as authentic and notable. Verified accounts are identified by a blue badge
              with a checkmark.
            </p>
            <p className="text-xs text-muted-foreground">
              Verification helps users identify genuine accounts of public interest.
            </p>
          </div>
        </TooltipContent>
      </Tooltip>
